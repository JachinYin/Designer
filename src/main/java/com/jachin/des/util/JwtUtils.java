...
public class JwtUtils {
     ...
     * 获取用户名从token中
     */
    public String getAidFromToken(String token) {
     ...
     */
    public String generateToken(String aid, String randomKey) {
        Map<String, Object> claims = new HashMap<>();
        claims.put(jwtProperties.getMd5Key(), randomKey);
        return doGenerateToken(claims, aid);
    }
